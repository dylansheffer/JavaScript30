...
function getVideo() {
  navigator.mediaDevices.getUserMedia({video: true, audio: false })
    ...
    .catch(err => {
      alert("Please Enable Web Cam!")
      console.log("Please Enable Web Cam!")
    });
}
...
function paintToCanvas() {
  ...
  // Doing a return on the setInterval so we can have access to
  // the interval if we need it
  return setInterval(() => {
...
function takePhoto() {
  ...
  link.innerHTML = `<img src="${data}" alt="webcam" />`;
